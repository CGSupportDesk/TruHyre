...
## [Unreleased] — quality and hardening

A multi-pass quality and hardening pass on the shipped product. The focus was
correctness, security, tests, observability, polish, and documentation.
